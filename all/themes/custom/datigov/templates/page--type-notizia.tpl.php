...
<!-- contenuto del content type notizia -->
<?php if ($logged_in): ?>
    <?php print render($tabs); ?>
<?php endif; ?>
<section id="contenuto_notizia" class="container fix_scroll">
    <header>    
        <h2 class="titolo_principale"><?php print $title; ?></h2>
        <div class="row">
            <div class="col-sm-6">
                <div class="pubblicato_quando">
                    <span>Pubblicato il: </span><?php print format_date($node->created); ?>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="sociali_notizie"><span></span></div>
            </div>
        </div>
    </header>
    <content>
        <div class="body_immagine">
            <?php print render($page['content']['system_main']['nodes'][$nid]['field_nn_image']); ?>
        </div>
