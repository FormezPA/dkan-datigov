...
<!--
                <div class="logo_text clearfix">
                    <h1 id="site-name">
                         <a href="/" title="Home">Dati.gov.it<br/><small>I dati aperti della Pubblica Amministrazione</small></a>
                    </h1>
                </div>
-->
            </div><!-- /logo_container -->
    ...
    <div id="main" class="main">
        ...
        <div class="main-row container">
            <section>
                ...
                <?php endif; ?>
                <div class="contenuto_sviluppatori row">
                    <div class="col-sm-8">
    ...
    <div class="container">
        <div class="row zona_loghino">
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 loghino">
                <img src="/<?php echo $directory; ?>/images/agid-logo.svg"/>
            </div>
        ...
        <div class="row zona_contatti">
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 contatti">
                <h2>dati.gov.it</h2> 
                <p>
                     Il Portale <a href="http://dati.gov.it">dati.gov.it</a> è il catalogo nazionale dei metadati relativi ai dati rilasciati in formato aperto dalle pubbliche amministrazioni italiane. Il Portale è promosso dal Governo Italiano e realizzato dall’Agenzia per l’Italia digitale.
                </p>
            </div>
...
<!--
                ...
                <div class="nav-social_footer">
                    ...
                    <a href="<?php echo $path; ?>/notizie.xml" target="_blank">
                        <i class="fa fa-rss-square" aria-hidden="true"></i>
                    </a>
                </div>
-->
