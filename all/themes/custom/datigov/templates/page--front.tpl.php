...
<div id="main-wrapper">
    <div id="main" class="main">
        ...
        <?php endif; ?>
        <div class="main-row container box_categorie">
            <section>
                <a id="main-content"></a>
        ...
        <div class="container_categorie">
            <div class="between container">
                <?php print render($page['zona_topic']); ?>
            </div>
        </div>
    </div> <!-- /#main -->
</div> <!-- /#main-wrapper -->
<!-- zona blocco_home -->
<div class="zona_news_home">
    <div class="container">
        <h4>In Evidenza:</h4>
        <?php print render($page['blocco_home']); ?>
    </div>
</div>
<!-- fine blocco_home -->
<!-- zona blocco_tweets -->
<div class="zona_tweets_home">
    <div class="container">
        <?php print render($page['zona_tweets']); ?>
    </div>
</div>
<!-- fine blocco_tweets -->
