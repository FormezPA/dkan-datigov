...
<!-- contenuto del content type evento -->
<?php if ($logged_in): ?>
    <?php print render($tabs); ?>
<?php endif; ?>
<section id="contenuto_evento" class="container fix_scroll">
    <header>    
    ...
    <content>
        <?php if($page['content']['system_main']['nodes'][$nid]['field_data_inizio_evento']) : ?>
            <div class="quando_evento">
                <h3 class="stile_tit"><i class="fa fa-clock-o" aria-hidden="true"></i> Quando:</h3>
                <div class="inside">
                    <?php 
                    echo '<span class="uu"> Da  </span>';
                    print render($page['content']['system_main']['nodes'][$nid]['field_data_inizio_evento']); 
                    echo '<span class="uu"> a </span>';
                    print render($page['content']['system_main']['nodes'][$nid]['field_data_fine_evento']); 
                    ?>
                </div>
            </div>
        <?php endif; ?>
        <?php if($page['content']['system_main']['nodes'][$nid]['field_localit_evento']) : ?>
            <div class="dove_evento">
                <h3 class="stile_tit">
                    <i class="fa fa-map-marker" aria-hidden="true"></i>
                    Dove:
                </h3>
                <div class="inside">
                    <?php print render($page['content']['system_main']['nodes'][$nid]['field_localit_evento']); ?>  
                </div>
            </div>
        <?php endif; ?>
        <?php if($page['content']['system_main']['nodes'][$nid]['field_link_evento']) : ?>
            <div class="link_evento">
                <h3 class="stile_tit">
                    <i class="fa fa-external-link" aria-hidden="true"></i>
                    Link:
                </h3>
                <div class="inside">
                    <?php print render($page['content']['system_main']['nodes'][$nid]['field_link_evento']); ?>
                </div>
            </div>
        <?php endif; ?>
    </content>
